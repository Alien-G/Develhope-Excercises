...
public class Main {
    ...
    private static void exercise4Bonus() {
        ...
        // Rounds the value up to the next whole number.
        ...
        // Rounds the value to the nearest whole number, in our case since it's 4.5 it rounds up to 5, instead of down to 4.
        System.out.println(ourValue + " after using round=" + Math.round(ourValue));
        // Raises our value by any given number of times, in this case 2. 4.5 * 4.5 = 20.25
        System.out.println(ourValue + " after using powerOf with the value of 2=" + Math.pow(ourValue, 2));
        // Raises our value by any given number of times, in this case 3. 4.5 * 4.5 * 4.5 = 91.125
        System.out.println(ourValue + " after using powerOf with the value of 3=" + Math.pow(ourValue, 3));
        // Generates a random value. Which in this case is multiplied by our assigned value.
