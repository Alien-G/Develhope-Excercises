...
public class Exercises {
    ...
    private static void exercise1() {
        ...
        System.out.println("The surface of the Rectangle is: " + rectangle1.calculateArea());

        Circle circle1 = new Circle(4);
        System.out.println("The surface of the Circle is: " + circle1.calculateArea());
    ...
    private static void exercise3() {
        ...
        Guitar guitar1 = new Guitar("ES-335","Gibson");
        Piano piano1 = new Piano("C3","Yamaha");
