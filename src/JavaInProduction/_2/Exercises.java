...
public class Exercises {
    ...
    private static void exercise1() {
        System.out.println("\nExercise 1: ");
        // Your code here
        List<Integer> evenNumbers = ourNumbers.stream().filter(num -> num % 2 == 0).toList();
    ...
    private static void exercise2() {
        ...
        List<Integer> evenNumbers = ourNumbers.stream().filter(num -> num % 2 == 1).toList();
    ...
    private static void exercise4() {
        System.out.println("\nExercise 4");
        //Your code here
        Set<Integer> result = ourNumbers.stream().filter(n -> n % 2 == 0).map(n -> n * 2).collect(Collectors.toSet());
