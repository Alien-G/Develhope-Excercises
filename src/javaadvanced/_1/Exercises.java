...
public class Exercises {
    ...
    private static void exercise1() {
        ...
        if (ourSet.containsAll(Set.of(1, 5, 2))) { //had to remove the multiple 1 in order to fix the error caused by Set.of()
    ...
    private static void exercise3() {
        ...
        //I had to switch min and max around because otherwise it wouldn't have worked.
