...
public class Main {
    ...
    private static void exercise2() {
        ...
        System.out.println("The smallest number in the list is "+ minNumber + " and the largest is " + maxNumber + ".");
    }
