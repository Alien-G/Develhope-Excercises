...
public class Main {
    ...
    public static void exercise2() {
        ...
        public static void exercise3Bonus () {
            ...
            switch (inputNumber) {
                case 2 -> System.out.println("Smallest prime number under 20");
                case 3 -> System.out.println("7th largest prime number under 20");
                case 5 -> System.out.println("6th largest prime number under 20");
                case 7 -> System.out.println("5th largest prime number under 20");
                case 11 -> System.out.println("4th largest prime number under 20");
                case 13 -> System.out.println("3rd largest prime number under 20");
                case 17 -> System.out.println("2nd largest prime number under 20");
                case 19 -> System.out.println("Largest prime number under 20");
